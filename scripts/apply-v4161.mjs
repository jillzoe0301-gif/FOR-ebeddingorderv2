...
const patchFile = new URL('./v4161.diff.gz.b64', import.meta.url);
...
if(original.includes('<title>FOR-e寢具訂購 V4.16.1</title>')){
  console.log('V4.16.1 already applied.');
}else{
  const updated=applyUnifiedDiff(original,diff);
  fs.writeFileSync(target,updated,'utf8');
  console.log('Applied FOR-e V4.16.1 horizontal accounting detail patch.');
}
